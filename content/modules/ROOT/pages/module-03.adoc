...
Again, navigate to *Operators* and then *Installed Operators* in the left hand menu.

Now, click the *OLSConfig* tab, and then click on the `cluster` instance. Finally, select the *YAML* tab.
